...
import com.kbj.androxlsxparser.mxlsxparser.exceptions.NotSupportedException;
...
public class StreamingCell implements Cell {
  ...
  public boolean getBooleanCellValue() {
    ...
    switch(cellType) {
      ...
      default:
        throw typeMismatch(Cell.CELL_TYPE_BOOLEAN, cellType, false);
    }
  }
  ...
  private static RuntimeException typeMismatch(int expectedType, int actualType, boolean isFormulaCell) {
   ...
   * @return one of ({@link Cell#CELL_TYPE_NUMERIC}, {@link Cell#CELL_TYPE_STRING},
   *     {@link Cell#CELL_TYPE_BOOLEAN}, {@link Cell#CELL_TYPE_ERROR}) depending
